...
def getOsInfo():
    ...
    data = {}
    data['hostname'] = "naihe"
    data['ip'] = "172.21.112.1"
    data['system'] = "Debian11"
    data['machine'] = "AMD64"
    return data
...
def GetCpuUsed(interval=1):
    ...
    return {'user': 22.8+x, 'system': 11.3+x, 'idle': 66.0+x, 'interrupt': 0.0+x, 'dpc': 0.0+x, 'total': 34.1+x}
    # {'user': 4.0, 'nice': 0.0, 'system': 1.0, 'idle': 95.0, 'iowait': 0.0, 'irq': 0.0, 'softirq': 0.0, 'steal': 0.0,
