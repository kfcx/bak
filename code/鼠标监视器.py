...
class MouseBlocker():
    ...
    def hookProc(nCode, wParam, lParam):
        HookStruct = genStruct("Hook", pt=genStruct("Point", x=LONG, y=LONG), mouseData=DWORD, flags=DWORD, time=DWORD,
                               dwExtraInfo=PULONG)
        ...
        if nCode < 0:
            ...
            if win32gui.GetWindowText(handle) == "4th | Gepard Shield 3.0 (^-_-^)":
                return 1
